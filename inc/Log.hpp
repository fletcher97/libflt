...
#define FLT_LOG_TRACE_MSG(X) (FLT_LOG_TRACE_COLOR_FG "[TRACE]" FLT_LOG_RESET_COLOR ": " + X)
#define FLT_LOG_DEBUG_MSG(X) (FLT_LOG_DEBUG_COLOR_FG "[DEBUG]" FLT_LOG_RESET_COLOR ": " + X)
#define FLT_LOG_INFO_MSG(X) (FLT_LOG_INFO_COLOR_FG "[INFO]" FLT_LOG_RESET_COLOR ": " + X)
#define FLT_LOG_WARN_MSG(X) (FLT_LOG_WARN_COLOR_FG "[WARN]" FLT_LOG_RESET_COLOR ": " + X)
#define FLT_LOG_ERROR_MSG(X) (FLT_LOG_ERROR_COLOR_FG "[ERROR]" FLT_LOG_RESET_COLOR ": " + X)
#define FLT_LOG_FATAL_MSG(X) (FLT_LOG_FATAL_COLOR_FG "[FATAL]" FLT_LOG_RESET_COLOR ": " + X)
